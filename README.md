...
If you want more open-ended, UK-English responses using an LLM **while still querying the DB/KB**, copy `.env.example` to `.env` and fill in your key:
...
- `OPENAI_API_KEY`
- optionally `OPENAI_MODEL`, `OPENAI_BASE_URL`
- `CHATBOT_USE_LLM=1`
